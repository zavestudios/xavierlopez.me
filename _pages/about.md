...
- Migrated the Amazon Machine Image (AMI) build process from local execution of Packer/Ansible to AWS Image Builder, reducing build time from 40 minutes to 5 minutes (87.5% improvement) while integrating automated OSCAP security scanning and remediation
