...
`git push -o merge_request.create -o merge_request.assign="product-owner@your-company.com" -o merge_request.description="Finished story number 123" -o merge_request.target=main`