...
Here's another bit of command line usefullness that I repeatedly need, but never remember. It does a great job of making the query result readable, and uncluttered by data you don't need. Let's get users, but only their firstnames, lastnames and emails. Also, let's use the table_print gem to prettify the results:
