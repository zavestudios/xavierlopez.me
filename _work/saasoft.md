...
order: 2
excerpt: "GitOps-driven CI/CD, Prometheus instrumentation, and Ruby on Rails development for SaaS infrastructure."
---

## Scope

DevOps and site reliability engineering for SaaS platform. Maintained GitOps-driven delivery pipelines and improved observability through metrics instrumentation.
...
- **GitOps pipelines** maintained for efficient delivery
- **Prometheus instrumentation** improved application observability
- **REST APIs and microservices** delivered on schedule

---

## Key Technologies

GitOps (Flux/ArgoCD), Prometheus, Ruby on Rails, REST APIs, Microservices
